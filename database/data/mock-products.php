...
return [
    1 => [
        'id' => 1,
        'name' => 'Silla blanca de plástico',
        'description' => 'Silla todoterreno a precio de saldo.',
        'color' => 'Blanco',
        'stock' => 321,
        'price' => 3.00,
        'category_id' => 1,
    ...
    4 => [
        'id' => 4,
        'name' => 'Estantería beige XXL',
        'description' => 'Estantería de pared color beige con gran capacidad.',
        'color' => 'Beige',
        'stock' => 223,
        'price' => 50.00,
        'category_id' => 3,
    ...
    8 => [
        'id' => 8,
        'name' => 'Mecedora chirriante',
        'description' => 'Un buen lugar para echarse una siesta, si se está un poco sordo.',
        'color' => 'Rojo',
        'stock' => 31,
        'price' => 64.00,
        'category_id' => 1,
