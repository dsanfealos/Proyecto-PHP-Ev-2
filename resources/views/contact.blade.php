...
@section('content')
    <div class="container mx-auto px-6 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-blue-200 rounded-lg shadow-lg p-8 flex flex-col">                
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Contacto directo</h2>
                <p class="text-gray-600 mb-4"><br>Puedes llamarnos al teléfono 676 121 353. El horario de antención al cliente es de 9h a 14h de lunes a viernes.</p>
                <p class="text-gray-600 mb-4">En caso de querer enviar un correo electrónico, nuestra dirección es info@kuatropatas.es .</p>
                <br>
                <h2 class="text-2xl font-bold text-gray-800 mb-2"><br>Redes</h2>
                <p class="text-gray-600 mb-4"><br>Instagram: @kuatropatas</p>
