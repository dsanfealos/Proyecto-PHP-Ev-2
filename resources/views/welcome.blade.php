...
@section('title', 'Bienvenido - Muebles Kuatropatas')
        ...
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('products.index') }}"
                    ...
                    hover:bg-gray-100 transition duration-300 ease-in-out transform hover:scale-
                    105">
                    Ver Productos
                </a>
                <a href="{{ route('products.on-sale') }}"
                    class="border-2 border-white text-white font-bold py-4 px-8
                    rounded-full hover:bg-white hover:text-primary-600 transition duration-300 easein-
                    out">
                    🏷 Ofertas Especiales
                </a>
            </div>
